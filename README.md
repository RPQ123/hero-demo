...
<p align="center">守望先锋风格 · 非官方粉丝 DEMO · 单机网页射击 · v1.87</p>
<p align="center">
...
修正运输机到位时的转向：现在机头与飞行方向一致，沿同一航向接近、悬停，并直接从右侧舱门部署。离舱后，运输机加速爬升飞走，推进器尾焰增强；只有进入远景雾的不可见范围后才清理模型，取消固定计时消失。

保留高空进场过场、到位前空气墙、自由落体期间禁用技能、落地恢复及四档难度下调，旧存档继续可用。
...
当前公开版本：**v1.87**。下方介绍 PPT 与部分宣传截图保留自早期版本；当前玩法与画面以在线游戏为准。
