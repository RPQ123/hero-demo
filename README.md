...
<p align="center">守望先锋风格 · 非官方粉丝 DEMO · 单机网页射击 · v1.90</p>
<p align="center">
...
困难与挑战关闭额外任务高亮和方向指引，挑战恢复英雄技能治疗并继续移除血包。飞行敌人可以升高越障、降低高度从门洞绕出；地面移动、侧移步态和飞行姿态更平滑。

同步 v1.88–v1.89 的舰船场景修正：封闭并细化弧形船壳，加入峡谷岸景、水流与航行表现，修复悬空设施、地面武器残留手臂和跟船岩石；简单和正常提供任务引导，第一章通道加入通缉海报彩蛋。旧存档继续可用。
...
当前公开版本：**v1.90**。下方介绍 PPT 与部分宣传截图保留自早期版本；当前玩法与画面以在线游戏为准。
